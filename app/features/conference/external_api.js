!(function(e, t) {
    typeof exports === 'object' && typeof module === 'object' ? module.exports = t() : typeof define === 'function' && define.amd ? define([], t) : typeof exports === 'object' ? exports.JitsiMeetExternalAPI = t() : e.JitsiMeetExternalAPI = t();
})(self, () => (() => {
    const e = {
        // eslint-disable-next-line no-shadow
            820: (e, t, n) => {
                ...
                function d(e) {
                    ...
                    if (n) {
                        ...
                        i !== 'http:' && i !== 'https:' && (i = 'https:'), (e = e.substring(t.lastIndex)).startsWith('//') && (e = i + e);
                    }
                ...
                function h(e) {
                    ...
                    if (e = e.replace(/\s/g, ''), n = new RegExp('^([a-z][a-z0-9\\.\\+-]*:)', 'gi'), i = n.exec(e), i && (t.protocol = i[1].toLowerCase(), e = e.substring(n.lastIndex)), n = new RegExp('^(//[^/?#]+)', 'gi'), i = n.exec(e), i) {
                        ...
                        s !== -1 && (r = r.substring(s + 1)), t.host = r;
                        const o = r.lastIndexOf(':');

                        o !== -1 && (t.port = r.substring(o + 1), r = r.substring(0, o)), t.hostname = r;
                    }
                    if (n = new RegExp('^([^?#]*)', 'gi'), i = n.exec(e), i && (r = i[1], e = e.substring(n.lastIndex)), r ? r.startsWith('/') || (r = `/${r}`) : r = '/', t.pathname = r, e.startsWith('?')) {
                        let n = e.indexOf('#', 1);

                        n === -1 && (n = e.length), t.search = e.substring(0, n), e = e.substring(n);
                    } else {
                        t.search = '';
                    }
                ...
                class v {
                    constructor() {
                        const { postisOptions: e } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};

                        this.postis = (function(e) {
                            let t, n = e.scope, i = e.window, r = e.windowForEventListening || window,
                            ...
                            var h = {
                                    listen(e, t) {
                                        ...
                                        if (n) {
                                            for (let i = o[e], r = 0; r < i.length; r++) {
                                    ...
                                    send(e) {
                                        ...
                                        (l || e.method === d) && i && typeof i.postMessage === 'function' ? i.postMessage(JSON.stringify({
                                            postis: !0,
                                            scope: n,
                                            method: t,
                                            params: e.params
                                    ...
                                    destroy(e) {
                                        clearInterval(t), l = !1, r && typeof r.removeEventListener === 'function' && r.removeEventListener('message', u), e && e();
                                    }
                                }, p = `${Number(new Date()) + Math.random()}`;
                ...
                const _ = 'response', y = 'request';

                class b {
                    constructor() {
                        const { backend: e } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    ...
                    _onMessageReceived(e) {
                        if (e.type === _) {
                            ...
                            e.type === y ? this.emit('request', e.data, (t, n) => {
                                this._backend.send({
                                    type: _,
                                    error: n,
                                    id: e.id,
                ...
                (function(e, t = !1, n = 'hash') {
                    ...
                    const i = n === 'search' ? e.search : e.hash, r = {}, s = (i == null ? void 0 : i.substr(1)
                        .split('&')) || [];

                    if (n === 'hash' && s.length === 1) {
                        const e = s[0];

                        if (e.startsWith('/') && e.split('&').length === 1) {
                            return r;
                        }
                    }
                    ...
                    return s.forEach(e => {
                        ...
                        try {
                            if (s = n[1], !t) {
                                ...
                                s = e === 'undefined' ? void 0 : a.parse(e);
                            }
                        } catch (e) {
                            return void (function(e, t = '') {
                                let n;

                                console.error(t, e), (n = window.onerror) === null || void 0 === n || n.call(window, t, void 0, void 0, void 0, e);
                ...
                const C = [ 'css/all.css', 'libs/alwaysontop.min.js' ], E = {
                ...
                function S(e) {
                    ...
                    return typeof e === 'string' && String(e)
                        .match(/([0-9]*\.?[0-9]+)(em|pt|px|%)$/) !== null ? t = e : typeof e === 'number' && (t = `${e}px`), t;
                }
                ...
                class j extends r() {
                    constructor(e) {
                        ...
                        }), Array.isArray(m) && m.length > 0 && this.invite(m), this._tmpE2EEKey = _, this._isLargeVideoVisible = !1, this._isPrejoinVideoVisible = !1, this._numberOfParticipants = 0, this._participants = {}, this._myUserID = void 0, this._onStageParticipant = void 0, this._setupListeners(), O++;
                    }

                    _createIFrame(e, t, n) {
                        const i = `jitsiConferenceFrame${O}`;

                        this._frame = document.createElement('iframe'), this._frame.allow = 'camera; microphone; display-capture; autoplay; clipboard-write', this._frame.name = i, this._frame.id = i, this._setSize(e, t), this._frame.sandbox = 'allow-scripts allow-same-origin allow-popups allow-forms', this._frame.setAttribute('allowFullScreen', 'true'), this._frame.style.border = 0, n && (this._frame.onload = n), this._frame = this._parentNode.appendChild(this._frame), this._frame.src = this._url;
                    }
                    ...
                    _setupListeners() {
                        this._transport.on('event', e => {
                            ...
                            case 'participant-joined':
                                this._participants[i] = this._participants[i] || {}, this._participants[i].displayName = n.displayName, this._participants[i].formattedDisplayName = n.formattedDisplayName, R(this, 1);
                                break;
                            ...
                            return Boolean(r) && (this.emit(r, n), !0);
                        });
                    }
                    ...
                    updateNumberOfParticipants(e) {
                        ...
                        const t = Object.keys(e)
                            .reduce((t, n) => {
                                ...
                                return (i = e[n]) !== null && void 0 !== i && i.participants ? Object.keys(e[n].participants).length + t : t;
                            }, 0);
                    ...
                    invite(e) {
                        return Array.isArray(e) && e.length !== 0 ? this._transport.sendRequest({
                            name: 'invite',
                            invitees: e
            ...
            571: (e, t) => {
                ...
                t.parse = function(e) {
                    const i = typeof (arguments.length <= 1 ? void 0 : arguments[1]) === 'object' && (arguments.length <= 1 ? void 0 : arguments[1]),
                    ...
                    return s.protoAction === 'ignore' ? o : o && typeof o === 'object' && e.match(n) ? (t.scan(o, s), o) : o;
                }, t.scan = function(e) {
            ...
            369: (e, t, n) => {
                ...
                function r(e, t) {
                    this.logStorage = e, this.stringifyObjects = !(!t || !t.stringifyObjects) && t.stringifyObjects, this.storeInterval = t && t.storeInterval ? t.storeInterval : 3e4, this.maxEntryLength = t && t.maxEntryLength ? t.maxEntryLength : 1e4, Object.keys(i.levels)
                        .forEach(e => {
                ...
                r.prototype.stringify = function(e) {
                    ...
                    for (var t = '', n = 1, r = arguments.length; n < r; n++) {
                        ...
                        !this.stringifyObjects && e !== i.levels.ERROR || typeof s !== 'object' || (s = this.stringify(s)), t += s, n !== r - 1 && (t += ' ');
                    }

                    return t.length ? t : null;
                }, r.prototype._log = function() {
                    const e = arguments[1], t = this.formatLogMessage.apply(this, arguments);

                    if (t) {
                        const n = this.queue[this.queue.length - 1], i = n && n.text;
                    ...
                    this.totalLen > 0 && (this.logStorage.isReady() || e) && (this.logStorage.isReady() ? (this.outputCache.length && (this.outputCache.forEach(e => {
                        this.logStorage.storeLogs(e);
                    }), this.outputCache = []), this.logStorage.storeLogs(this.queue)) : this.outputCache.push(this.queue), this.queue = [], this.totalLen = 0), t && this._reschedulePublishInterval();
            ...
            7: e => {
                ...
                function r() {
                    ...
                    return n[3] && (i = n[3].match(/\s*at\s*(.+?)\s*\((\S*)\s*:(\d*)\s*:(\d*)\)/)), !i || i.length <= 4 ? (n[2].indexOf('log@') === 0 ? e.methodName = n[3].substr(0, n[3].indexOf('@')) : e.methodName = n[2].substr(0, n[2].indexOf('@')), e) : (e.methodName = i[1], e.fileLocation = i[2], e.line = i[3], e.column = i[4], e);
                }

                function s() {
                    const e = arguments[0], s = arguments[1], o = Array.prototype.slice.call(arguments, 2);

                    if (!(t[s] < e.level)) {
                        for (let a = !(e.options.disableCallerInfo || i.disableCallerInfo) && r(), c = n.concat(e.transports), l = 0; l < c.length; l++) {
                            const d = c[l], u = d[s];
                ...
                function o(e, n, i, r) {
                    this.id = n, this.options = r || {}, this.transports = i, this.transports || (this.transports = []), this.level = t[e];
                    for (let o = Object.keys(t), a = 0; a < o.length; a++) {
            ...
            860: (e, t, n) => {
                let i = n(7), r = n(369), s = {}, o = [], a = i.levels.TRACE;
                ...
                e.exports = {
                    ...
                    getLogger(e, t, n) {
                        const r = new i(a, e, t, n);

                        return e ? (s[e] = s[e] || [], s[e].push(r)) : o.push(r), r;
                    },
                    setLogLevelById(e, t) {
                        for (let n = t ? s[t] || [] : o, i = 0; i < n.length; i++) {
                            n[i].setLevel(e);
                        }
                    },
                    setLogLevel(e) {
            ...
            620: e => {
                ...
                let t, n = typeof Reflect === 'object' ? Reflect : null,
                    i = n && typeof n.apply === 'function' ? n.apply : function(e, t, n) {
                        return Function.prototype.apply.call(e, t, n);
                    };

                t = n && typeof n.ownKeys === 'function' ? n.ownKeys : Object.getOwnPropertySymbols ? function(e) {
                    return Object.getOwnPropertyNames(e)
                        .concat(Object.getOwnPropertySymbols(e));
                } : function(e) {
                    return Object.getOwnPropertyNames(e);
                };
                const r = Number.isNaN || function(e) {
                    return e != e;
                };
                ...
                e.exports = s, e.exports.once = function(e, t) {
                    return new Promise((n, i) => {
                        ...
                        m(e, t, s, { once: !0 }), t !== 'error' && (function(e, t, n) {
                            typeof e.on === 'function' && m(e, 'error', t, { once: !0 });
                        })(e, r);
                    });
                ...
                function l(e, t, n, i) {
                    ...
                    if (a(n), void 0 === (s = e._events) ? (s = e._events = Object.create(null), e._eventsCount = 0) : (void 0 !== s.newListener && (e.emit('newListener', t, n.listener ? n.listener : n), s = e._events), o = s[t]), void 0 === o) {
                        o = s[t] = n, ++e._eventsCount;
                    } else if (typeof o === 'function' ? o = s[t] = i ? [ n, o ] : [ o, n ] : i ? o.unshift(n) : o.push(n), (r = c(e)) > 0 && o.length > r && !o.warned) {
                        o.warned = !0;
                        const d = new Error(`Possible EventEmitter memory leak detected. ${o.length} ${String(t)} listeners added. Use emitter.setMaxListeners() to increase limit`);
                ...
                function h(e, t, n) {
                    ...
                    return void 0 === r ? [] : typeof r === 'function' ? n ? [ r.listener || r ] : [ r ] : n ? (function(e) {
                ...
                Object.defineProperty(s, 'defaultMaxListeners', {
                    ...
                    if (n === t || n.listener === t) {
                        ...
                        r === 0 ? n.shift() : (function(e, t) {
                            for (; t + 1 < e.length; t++) {
                                e[t] = e[t + 1];
                            }
                            e.pop();
                        })(n, r), n.length === 1 && (i[e] = n[0]), void 0 !== i.removeListener && this.emit('removeListener', e, o || t);
                    }
                    ...
                    if (void 0 === n.removeListener) {
                        return arguments.length === 0 ? (this._events = Object.create(null), this._eventsCount = 0) : void 0 !== n[e] && (--this._eventsCount == 0 ? this._events = Object.create(null) : delete n[e]), this;
                    }
                    if (arguments.length === 0) {
                        let r, s = Object.keys(n);

                        for (i = 0; i < s.length; ++i) {
                            (r = s[i]) !== 'removeListener' && this.removeAllListeners(r);
                        }
